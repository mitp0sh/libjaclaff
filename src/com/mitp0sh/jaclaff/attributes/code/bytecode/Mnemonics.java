...
{
	public static final byte BC_nop                  = (byte)   0; // 0x00
    public static final byte BC_aconst_null          = (byte)   1; // 0x01
    public static final byte BC_iconst_m1            = (byte)   2; // 0x02
    public static final byte BC_iconst_0             = (byte)   3; // 0x03
    public static final byte BC_iconst_1             = (byte)   4; // 0x04
    public static final byte BC_iconst_2             = (byte)   5; // 0x05
    public static final byte BC_iconst_3             = (byte)   6; // 0x06
    public static final byte BC_iconst_4             = (byte)   7; // 0x07
    public static final byte BC_iconst_5             = (byte)   8; // 0x08
    public static final byte BC_lconst_0             = (byte)   9; // 0x09
    public static final byte BC_lconst_1             = (byte)  10; // 0x0a
    public static final byte BC_fconst_0             = (byte)  11; // 0x0b
    public static final byte BC_fconst_1             = (byte)  12; // 0x0c
    public static final byte BC_fconst_2             = (byte)  13; // 0x0d
    public static final byte BC_dconst_0             = (byte)  14; // 0x0e
    public static final byte BC_dconst_1             = (byte)  15; // 0x0f
    public static final byte BC_bipush               = (byte)  16; // 0x10
    public static final byte BC_sipush               = (byte)  17; // 0x11
    public static final byte BC_ldc                  = (byte)  18; // 0x12
    public static final byte BC_ldc_w                = (byte)  19; // 0x13
    public static final byte BC_ldc2_w               = (byte)  20; // 0x14
    public static final byte BC_iload                = (byte)  21; // 0x15
    public static final byte BC_lload                = (byte)  22; // 0x16
    public static final byte BC_fload                = (byte)  23; // 0x17
    public static final byte BC_dload                = (byte)  24; // 0x18
    public static final byte BC_aload                = (byte)  25; // 0x19
    public static final byte BC_iload_0              = (byte)  26; // 0x1a
    public static final byte BC_iload_1              = (byte)  27; // 0x1b
    public static final byte BC_iload_2              = (byte)  28; // 0x1c
    public static final byte BC_iload_3              = (byte)  29; // 0x1d
    public static final byte BC_lload_0              = (byte)  30; // 0x1e
    public static final byte BC_lload_1              = (byte)  31; // 0x1f
    public static final byte BC_lload_2              = (byte)  32; // 0x20
    public static final byte BC_lload_3              = (byte)  33; // 0x21
    public static final byte BC_fload_0              = (byte)  34; // 0x22
    public static final byte BC_fload_1              = (byte)  35; // 0x23
    public static final byte BC_fload_2              = (byte)  36; // 0x24
    public static final byte BC_fload_3              = (byte)  37; // 0x25
    public static final byte BC_dload_0              = (byte)  38; // 0x26
    public static final byte BC_dload_1              = (byte)  39; // 0x27
    public static final byte BC_dload_2              = (byte)  40; // 0x28
    public static final byte BC_dload_3              = (byte)  41; // 0x29
    public static final byte BC_aload_0              = (byte)  42; // 0x2a
    public static final byte BC_aload_1              = (byte)  43; // 0x2b
    public static final byte BC_aload_2              = (byte)  44; // 0x2c
    public static final byte BC_aload_3              = (byte)  45; // 0x2d
    public static final byte BC_iaload               = (byte)  46; // 0x2e
    public static final byte BC_laload               = (byte)  47; // 0x2f
    public static final byte BC_faload               = (byte)  48; // 0x30
    public static final byte BC_daload               = (byte)  49; // 0x31
    public static final byte BC_aaload               = (byte)  50; // 0x32
    public static final byte BC_baload               = (byte)  51; // 0x33
    public static final byte BC_caload               = (byte)  52; // 0x34
    public static final byte BC_saload               = (byte)  53; // 0x35
    public static final byte BC_istore               = (byte)  54; // 0x36
    public static final byte BC_lstore               = (byte)  55; // 0x37
    public static final byte BC_fstore               = (byte)  56; // 0x38
    public static final byte BC_dstore               = (byte)  57; // 0x39
    public static final byte BC_astore               = (byte)  58; // 0x3a
    public static final byte BC_istore_0             = (byte)  59; // 0x3b
    public static final byte BC_istore_1             = (byte)  60; // 0x3c
    public static final byte BC_istore_2             = (byte)  61; // 0x3d
    public static final byte BC_istore_3             = (byte)  62; // 0x3e
    public static final byte BC_lstore_0             = (byte)  63; // 0x3f
    public static final byte BC_lstore_1             = (byte)  64; // 0x40
    public static final byte BC_lstore_2             = (byte)  65; // 0x41
    public static final byte BC_lstore_3             = (byte)  66; // 0x42
    public static final byte BC_fstore_0             = (byte)  67; // 0x43
    public static final byte BC_fstore_1             = (byte)  68; // 0x44
    public static final byte BC_fstore_2             = (byte)  69; // 0x45
    public static final byte BC_fstore_3             = (byte)  70; // 0x46
    public static final byte BC_dstore_0             = (byte)  71; // 0x47
    public static final byte BC_dstore_1             = (byte)  72; // 0x48
    public static final byte BC_dstore_2             = (byte)  73; // 0x49
    public static final byte BC_dstore_3             = (byte)  74; // 0x4a
    public static final byte BC_astore_0             = (byte)  75; // 0x4b
    public static final byte BC_astore_1             = (byte)  76; // 0x4c
    public static final byte BC_astore_2             = (byte)  77; // 0x4d
    public static final byte BC_astore_3             = (byte)  78; // 0x4e
    public static final byte BC_iastore              = (byte)  79; // 0x4f
    public static final byte BC_lastore              = (byte)  80; // 0x50
    public static final byte BC_fastore              = (byte)  81; // 0x51
    public static final byte BC_dastore              = (byte)  82; // 0x52
    public static final byte BC_aastore              = (byte)  83; // 0x53
    public static final byte BC_bastore              = (byte)  84; // 0x54
    public static final byte BC_castore              = (byte)  85; // 0x55
    public static final byte BC_sastore              = (byte)  86; // 0x56
    public static final byte BC_pop                  = (byte)  87; // 0x57
    public static final byte BC_pop2                 = (byte)  88; // 0x58
    public static final byte BC_dup                  = (byte)  89; // 0x59
    public static final byte BC_dup_x1               = (byte)  90; // 0x5a
    public static final byte BC_dup_x2               = (byte)  91; // 0x5b
    public static final byte BC_dup2                 = (byte)  92; // 0x5c
    public static final byte BC_dup2_x1              = (byte)  93; // 0x5d
    public static final byte BC_dup2_x2              = (byte)  94; // 0x5e
    public static final byte BC_swap                 = (byte)  95; // 0x5f
    public static final byte BC_iadd                 = (byte)  96; // 0x60
    public static final byte BC_ladd                 = (byte)  97; // 0x61
    public static final byte BC_fadd                 = (byte)  98; // 0x62
    public static final byte BC_dadd                 = (byte)  99; // 0x63
    public static final byte BC_isub                 = (byte) 100; // 0x64
    public static final byte BC_lsub                 = (byte) 101; // 0x65
    public static final byte BC_fsub                 = (byte) 102; // 0x66
    public static final byte BC_dsub                 = (byte) 103; // 0x67
    public static final byte BC_imul                 = (byte) 104; // 0x68
    public static final byte BC_lmul                 = (byte) 105; // 0x69
    public static final byte BC_fmul                 = (byte) 106; // 0x6a
    public static final byte BC_dmul                 = (byte) 107; // 0x6b
    public static final byte BC_idiv                 = (byte) 108; // 0x6c
    public static final byte BC_ldiv                 = (byte) 109; // 0x6d
    public static final byte BC_fdiv                 = (byte) 110; // 0x6e
    public static final byte BC_ddiv                 = (byte) 111; // 0x6f
    public static final byte BC_irem                 = (byte) 112; // 0x70
    public static final byte BC_lrem                 = (byte) 113; // 0x71
    public static final byte BC_frem                 = (byte) 114; // 0x72
    public static final byte BC_drem                 = (byte) 115; // 0x73
    public static final byte BC_ineg                 = (byte) 116; // 0x74
    public static final byte BC_lneg                 = (byte) 117; // 0x75
    public static final byte BC_fneg                 = (byte) 118; // 0x76
    public static final byte BC_dneg                 = (byte) 119; // 0x77
    public static final byte BC_ishl                 = (byte) 120; // 0x78
    public static final byte BC_lshl                 = (byte) 121; // 0x79
    public static final byte BC_ishr                 = (byte) 122; // 0x7a
    public static final byte BC_lshr                 = (byte) 123; // 0x7b
    public static final byte BC_iushr                = (byte) 124; // 0x7c
    public static final byte BC_lushr                = (byte) 125; // 0x7d
    public static final byte BC_iand                 = (byte) 126; // 0x7e
    public static final byte BC_land                 = (byte) 127; // 0x7f
    public static final byte BC_ior                  = (byte) 128; // 0x80
    public static final byte BC_lor                  = (byte) 129; // 0x81
    public static final byte BC_ixor                 = (byte) 130; // 0x82
    public static final byte BC_lxor                 = (byte) 131; // 0x83
    public static final byte BC_iinc                 = (byte) 132; // 0x84
    public static final byte BC_i2l                  = (byte) 133; // 0x85
    public static final byte BC_i2f                  = (byte) 134; // 0x86
    public static final byte BC_i2d                  = (byte) 135; // 0x87
    public static final byte BC_l2i                  = (byte) 136; // 0x88
    public static final byte BC_l2f                  = (byte) 137; // 0x89
    public static final byte BC_l2d                  = (byte) 138; // 0x8a
    public static final byte BC_f2i                  = (byte) 139; // 0x8b
    public static final byte BC_f2l                  = (byte) 140; // 0x8c
    public static final byte BC_f2d                  = (byte) 141; // 0x8d
    public static final byte BC_d2i                  = (byte) 142; // 0x8e
    public static final byte BC_d2l                  = (byte) 143; // 0x8f
    public static final byte BC_d2f                  = (byte) 144; // 0x90
    public static final byte BC_i2b                  = (byte) 145; // 0x91
    public static final byte BC_i2c                  = (byte) 146; // 0x92
    public static final byte BC_i2s                  = (byte) 147; // 0x93
    public static final byte BC_lcmp                 = (byte) 148; // 0x94
    public static final byte BC_fcmpl                = (byte) 149; // 0x95
    public static final byte BC_fcmpg                = (byte) 150; // 0x96
    public static final byte BC_dcmpl                = (byte) 151; // 0x97
    public static final byte BC_dcmpg                = (byte) 152; // 0x98
    public static final byte BC_ifeq                 = (byte) 153; // 0x99
    public static final byte BC_ifne                 = (byte) 154; // 0x9a
    public static final byte BC_iflt                 = (byte) 155; // 0x9b
    public static final byte BC_ifge                 = (byte) 156; // 0x9c
    public static final byte BC_ifgt                 = (byte) 157; // 0x9d
    public static final byte BC_ifle                 = (byte) 158; // 0x9e
    public static final byte BC_if_icmpeq            = (byte) 159; // 0x9f
    public static final byte BC_if_icmpne            = (byte) 160; // 0xa0
    public static final byte BC_if_icmplt            = (byte) 161; // 0xa1
    public static final byte BC_if_icmpge            = (byte) 162; // 0xa2
    public static final byte BC_if_icmpgt            = (byte) 163; // 0xa3
    public static final byte BC_if_icmple            = (byte) 164; // 0xa4
    public static final byte BC_if_acmpeq            = (byte) 165; // 0xa5
    public static final byte BC_if_acmpne            = (byte) 166; // 0xa6
    public static final byte BC_goto                 = (byte) 167; // 0xa7
    public static final byte BC_jsr                  = (byte) 168; // 0xa8
    public static final byte BC_ret                  = (byte) 169; // 0xa9
    public static final byte BC_tableswitch          = (byte) 170; // 0xaa
    public static final byte BC_lookupswitch         = (byte) 171; // 0xab
    public static final byte BC_ireturn              = (byte) 172; // 0xac
    public static final byte BC_lreturn              = (byte) 173; // 0xad
    public static final byte BC_freturn              = (byte) 174; // 0xae
    public static final byte BC_dreturn              = (byte) 175; // 0xaf
    public static final byte BC_areturn              = (byte) 176; // 0xb0
    public static final byte BC_return               = (byte) 177; // 0xb1
    public static final byte BC_getstatic            = (byte) 178; // 0xb2
    public static final byte BC_putstatic            = (byte) 179; // 0xb3
    public static final byte BC_getfield             = (byte) 180; // 0xb4
    public static final byte BC_putfield             = (byte) 181; // 0xb5
    public static final byte BC_invokevirtual        = (byte) 182; // 0xb6
    public static final byte BC_invokespecial        = (byte) 183; // 0xb7
    public static final byte BC_invokestatic         = (byte) 184; // 0xb8
    public static final byte BC_invokeinterface      = (byte) 185; // 0xb9
    public static final byte BC_invokedynamic        = (byte) 186; // 0xba
    public static final byte BC_new                  = (byte) 187; // 0xbb
    public static final byte BC_newarray             = (byte) 188; // 0xbc
    public static final byte BC_anewarray            = (byte) 189; // 0xbd
    public static final byte BC_arraylength          = (byte) 190; // 0xbe
    public static final byte BC_athrow               = (byte) 191; // 0xbf
    public static final byte BC_checkcast            = (byte) 192; // 0xc0
    public static final byte BC_instanceof           = (byte) 193; // 0xc1
    public static final byte BC_monitorenter         = (byte) 194; // 0xc2
    public static final byte BC_monitorexit          = (byte) 195; // 0xc3
    public static final byte BC_wide                 = (byte) 196; // 0xc4
    public static final byte BC_multianewarray       = (byte) 197; // 0xc5
    public static final byte BC_ifnull               = (byte) 198; // 0xc6
    public static final byte BC_ifnonnull            = (byte) 199; // 0xc7
    public static final byte BC_goto_w               = (byte) 200; // 0xc8
    public static final byte BC_jsr_w                = (byte) 201; // 0xc9
    public static final byte BC_breakpoint           = (byte) 202; // 0xca
    
    public static final byte NUM_OF_REGULAR_BYTECODES = BC_breakpoint + 1;
    
    public static final byte FBC_agetfield                 = NUM_OF_REGULAR_BYTECODES;
    public static final byte FBC_bgetfield                 = NUM_OF_REGULAR_BYTECODES + 1;
    public static final byte FBC_cgetfield                 = NUM_OF_REGULAR_BYTECODES + 2;
    public static final byte FBC_dgetfield                 = NUM_OF_REGULAR_BYTECODES + 3;
    public static final byte FBC_fgetfield                 = NUM_OF_REGULAR_BYTECODES + 4;
    public static final byte FBC_igetfield                 = NUM_OF_REGULAR_BYTECODES + 5;
    public static final byte FBC_lgetfield                 = NUM_OF_REGULAR_BYTECODES + 6;
    public static final byte FBC_sgetfield                 = NUM_OF_REGULAR_BYTECODES + 7;

    public static final byte FBC_aputfield                 = NUM_OF_REGULAR_BYTECODES + 8;
    public static final byte FBC_bputfield                 = NUM_OF_REGULAR_BYTECODES + 9;
    public static final byte FBC_cputfield                 = NUM_OF_REGULAR_BYTECODES + 10;
    public static final byte FBC_dputfield                 = NUM_OF_REGULAR_BYTECODES + 11;
    public static final byte FBC_fputfield                 = NUM_OF_REGULAR_BYTECODES + 12;
    public static final byte FBC_iputfield                 = NUM_OF_REGULAR_BYTECODES + 13;
    public static final byte FBC_lputfield                 = NUM_OF_REGULAR_BYTECODES + 14;
    public static final byte FBC_sputfield                 = NUM_OF_REGULAR_BYTECODES + 15;

    public static final byte FBC_aload_0                   = NUM_OF_REGULAR_BYTECODES + 16;
    public static final byte FBC_iaccess_0                 = NUM_OF_REGULAR_BYTECODES + 17;
    public static final byte FBC_aaccess_0                 = NUM_OF_REGULAR_BYTECODES + 18;
    public static final byte FBC_faccess_0                 = NUM_OF_REGULAR_BYTECODES + 19;

    public static final byte FBC_iload                     = NUM_OF_REGULAR_BYTECODES + 20;
    public static final byte FBC_iload2                    = NUM_OF_REGULAR_BYTECODES + 21;
    public static final byte FBC_icaload                   = NUM_OF_REGULAR_BYTECODES + 22;

    public static final byte FBC_invokefinal               = NUM_OF_REGULAR_BYTECODES + 23;
    public static final byte FBC_linearswitch              = NUM_OF_REGULAR_BYTECODES + 24;
    public static final byte FBC_binaryswitch              = NUM_OF_REGULAR_BYTECODES + 25;

    public static final byte FBC_return_register_finalizer = NUM_OF_REGULAR_BYTECODES + 26;
